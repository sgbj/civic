...
import AirtableTestVisualization from "./AirtableTestVisualization";

const AirtableTestMeta = (/* data */) => ({
  title: "Airtable Test",
  slug: "airtable-test",
  introText: (
    <p>
  ...
  visualization: AirtableTestVisualization, // data, isLoading are passed to this as props
  additionalText: (
    <p>
...
export default AirtableTestMeta;
