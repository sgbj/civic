...
export default () =>
  storiesOf("Design|Brand/Logos", module).add(() => {
    return (
      <div style={storybookStyles.main}>
        <h1>Logos</h1>
        <h2>Quick Usage Guide</h2>
        <p>
          This quick usage guide should assist in using the appropriate logo
          version for most applications. Examples of each version in use
          follows.
        </p>
        ...
        <p>
          ...
          primary brand content where “CIVIC” is already understood by the
          audience.
        </p>
        <div style={storybookStyles.logo}>
        ...
        <p>
          Select the appropriate color version for the background behind the
          logo.
        </p>
        <h4>Standard</h4>
