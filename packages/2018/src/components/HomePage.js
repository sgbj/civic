        ...
        >
          ...
          <div className={contentWrapper}>
            ...
            <div className={initialContentContainer}>
              <div className={buttonContainerStatic}>
                <a href="#getStarted">
                  <Button>Get started with your city &gt;</Button>
                </a>
              </div>
                ...
                <div className={cx(sectionContentWrapper, one)}>
                  <div className={contentLeftContainer}>
                    ...
                    <p className={listText}>
                      Empowering cities to create technology that is a
                      reflection their ambition, their values, and their
                      priorities.
                    </p>
                    <div className={listSubTitle}>Workflow</div>
                    <p className={listText}>
                      Bringing our experience to existing partnerships to
                      reshape and modernize current infrastructure and create a
                      process to ensure sustainable outcomes.
                    </p>
                  ...
                  <div className={contentRightContainer}>
                    ...
                    <p className={listText}>
                      Designing for maximum interoperability between systems
                      with reproducible standards that are built to scale.
                    </p>
              ...
              <div className={aboutCivicWrapper} id="getStarted">
                ...
                <div className={cx(sectionContentWrapper, leftThirdGrid)}>
                  <div className={leftThirdWrapper}>
                    ...
                    <p className={listText}>
                      The code for CIVIC is open source and free, but we
                      recognize cities will be most successful through a
                      supported process.
                    </p>
                    <p className={listText}>
                      We have resources to help navigate the technical
                      challenges and strategic opportunities that facilitate
                      long-term goals for cities engaging with modern data
                      systems.
                    </p>
                    <p className={listText}>
                      We’re announcing a call to action for cities who want to
                      work closely with people who are building the CIVIC
                      Platform to become members and benefit from hands-on
                      collaboration with our partner network.
                    </p>
                  ...
                  <div className={rightThirdWrapper}>
                    ...
                    <p className={listText}>
                      You can help make CIVIC! We’re actively building focus
                      teams across the country to develop new stories, new
                      features, and better functionality on the platform. If
                      you’re interested in collaborating with the people who are
                      creating CIVIC, we’d love to talk to you.
                    </p>
                    <a
                    ...
                    <p className={listText}>
                      ...
                      working with government or software. Start the
                      conversation by applying to join our network.
                    </p>
                    <a
                      href="http://hackoregon.org/joinacivicteam"
                      target="_blank"
              ...
              <div className={aboutCivicWrapper} id="aboutCivic">
                ...
                <div className={cx(sectionContentWrapper, rightThirdGrid)}>
                  <div className={cx(rightThirdWrapper, talkToUs)}>
                    <div className={listTitle}>
                      CIVIC launched to the world June 21st, 2018 at Hack
                      Oregon’s live Demo Day in Portland, Oregon.
                    </div>
                    <div className={listTitle}>
                    ...
                    <div className={iconAndTextWrapper}>
                      <a href="https://secure.squarespace.com/checkout/donate?donatePageId=551721b2e4b057e153f5c1cc">
                        <Button css={donateButton}>Donate</Button>
                      </a>
                      <span>
                        Help us continue to maintain and develop CIVIC.
                      </span>
                    </div>
                    <div className={iconAndTextWrapper}>
                  ...
                  <div className={leftThirdWrapper}>
                    ...
                    <p className={listText}>
                      The original concept, design, and source code for the
                      CIVIC platform was developed by volunteer teams at Hack
                      Oregon, a rapid-prototyping lab dedicated to creating open
                      data projects that bring insight to local information
                      challenges.
                    </p>
                    <p className={listText}>
